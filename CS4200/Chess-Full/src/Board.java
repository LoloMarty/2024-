...
public class Board extends JPanel implements MouseListener, MouseMotionListener {
    ...
    private Pair<Integer, Pair<Piece, Square>> MinMax_SelectPiece(boolean turnSelector, int depthLevel, int alpha,
            int beta, String prevPos, Stack<String> futureMoves) {
        LinkedList<Piece> pieces = null;
        if (turnSelector) {
            pieces = Wpieces;
        } else {
        ...
        for (int i = 0; i < pieces.size(); i++) {
            ...
            if ((pieceTemp != null) && ((turnSelector && (pieceTemp.getColor() == 1))
                ...
                Pair<Integer, Square> r = MinMax_SelectSquare(pieceTemp, turnSelector, depthLevel + 1, alpha, beta,
        ...
        futureMoves.push(oppPiece.getPositionName() + " to " + oppSqPosName + " Level: " + Integer.toString(depthLevel)
    ...
    private Pair<Integer, Square> MinMax_SelectSquare(Piece chessPiece, boolean turnSelector, int depthLevel, int alpha,
            int beta, String prevPos, Stack<String> futureMoves) {
        ...
        for (int j = 0; j < possibleMoves.size(); j++) {
            ...
            if ((sq.getOccupyingPiece() == null)
                ...
                int valMinMax = 0;
                Pair<Integer, Square> r = MinMax_SelectPiece(!turnSelector, depthLevel, alpha, beta, prevPos,
                        tempFutureMoves);
                valMinMax = r.getKey();
