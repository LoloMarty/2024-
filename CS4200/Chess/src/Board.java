...
public class Board extends JPanel implements MouseListener, MouseMotionListener {
    ...
    private Pair<Integer, Pair<Piece, Square>> MinMax_SelectPiece(boolean turnSelector, int depthLevel, String prevPos, int alpha, int beta) {
        LinkedList<Piece> pieces = null;
        if (turnSelector) {
            pieces = Wpieces;
        } else {
    ...
    private Pair<Integer, Square> MinMax_SelectSquare(Piece chessPiece, boolean turnSelector, int depthLevel, String prevPos, int alpha, int beta) {
        ...
        for (int j = 0; j < possibleMoves.size(); j++) {
            ...
            if ((sq.getOccupyingPiece() == null) ||
                ...
                Pair<Integer, Pair<Piece, Square>> r = MinMax_SelectPiece(
                        !turnSelector, depthLevel, prevPos, alpha, beta);
                valMinMax = r.getKey();
                ...
                if (legalMoves.contains(sq) && movable.contains(sq)
                    ...
                    if (cmd.blackCheckMated()) {
                        ...
                        if (!whiteTurn) {
                            ...
                            Pair<Integer, Pair<Piece, Square>> r = MinMax_SelectPiece(false, 0, newText, Integer.MIN_VALUE, Integer.MAX_VALUE);
